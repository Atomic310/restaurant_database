...
public class manager_GUI extends JFrame implements ActionListener {
  ...
  public static void main(String[] args)
  {
    ...
    Integer currWeek = 0;
	//start and end date
	String startDate = "2022-3-4";
	String endDate = "2022-3-4";
	

    try{
	  //create statement and query for obtaining results
	...
	/*
	String getRecap = "SELECT day, daily_total FROM WeeklySales WHERE dates BETWEEN '" + startDate + "' AND '"+endDate+"';";
	*/
	...
	//input range to view finances between dates
	/////////////////will REPLACE///////////////////////////////////////////////
    //JTextArea timeInput = new JTextArea(Integer.toString(currWeek));//enter weekid
	/////////////////will add/////////////////////////////////////////////////

	JTextArea dateInput1 = new JTextArea(startDate);
    JTextArea dateInput2 = new JTextArea(endDate);
	
	JButton finSearch = new JButton("Search");
    // JTextArea timeStart = new JTextArea();
    // JTextArea timeEnd = new JTextArea();
    
    dateInput1.setSize(100, 100);
    dateInput1.add(timeframeLbl);
    ...
    for(int a = 1; a <= currWeek; ++a) {
      try{
		...
		String getWeekDetails = "SELECT day, daily_total FROM WeeklySales WHERE dates BETWEEN '" + startDate + "' AND '"+endDate+"';";
        Statement stmt = conn.createStatement();
